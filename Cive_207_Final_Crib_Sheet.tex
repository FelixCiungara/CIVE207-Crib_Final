...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=1, anchor=north east] (image) at (\linewidth,-0.5cm) {\includegraphics[width=0.80in]{image29.png}};
\node[opacity=1, anchor=north east] (image) at (\linewidth+0.5cm,-2.0cm) {\includegraphics[width=0.80in]{image30.png}};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=0.7, anchor=north] (image) at (0.5\linewidth,0) {\includegraphics[width=0.60\linewidth]{image25.png}};
\end{tikzpicture}
...
\noindent
\begin{minipage}[t]{0.333\linewidth}\centering\textbf{Steel}\\\includegraphics[width=\linewidth]{image39.png}\end{minipage}\hfill
\begin{minipage}[t]{0.333\linewidth}\centering\textbf{Alum.}\\\includegraphics[width=\linewidth]{image40.png}\end{minipage}\hfill
\begin{minipage}[t]{0.333\linewidth}\centering\textbf{Wood}\\\includegraphics[width=\linewidth]{image41.png}\end{minipage}
