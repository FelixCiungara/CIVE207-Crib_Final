...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=0.7, anchor=north west] (image) at (0,-1.0cm) {\includegraphics[width=0.50in]{image35.png}};
\node[opacity=0.7, anchor=north east] (image) at (\linewidth,-1.0cm) {\includegraphics[width=0.50in]{image36.png}};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=0.7, anchor=north east] (image) at (\linewidth+0.5cm,-10pt) {\includegraphics[width=1.0in]{image12.png}};
\node[opacity=0.7, anchor=north east] (image) at (\linewidth,-3cm) {\includegraphics[width=1.0in]{image11.png}};
\node[opacity=0.7, anchor=north east] (image) at (\linewidth,-5cm) {\includegraphics[width=1.0in]{image37.png}};
\end{tikzpicture}
