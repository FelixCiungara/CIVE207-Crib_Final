...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=0.7, anchor=north east] (image) at (\linewidth,-10pt) {\includegraphics[width=0.8in]{image6.png}};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=0.7, anchor=north east] (image) at (\linewidth,-10pt) {\includegraphics[width=0.6in]{image7.png}};
\end{tikzpicture}
