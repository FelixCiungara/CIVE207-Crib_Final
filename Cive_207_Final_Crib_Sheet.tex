...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=1, anchor=north east] (image) at (\linewidth,1.0cm) {\includegraphics[width=0.80in]{image29.png}};
...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=1.0, anchor=north east] (image) at (\linewidth,0cm) {\includegraphics[width=0.60in]{image38.png}};
\end{tikzpicture}
