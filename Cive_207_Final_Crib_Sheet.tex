...
\vspace{1cm}
\begin{center}
\includegraphics[width=0.5in]{image31.png}
\end{center}
same principle for centroid
\begin{center}
\includegraphics[width=0.5in]{image32.png}
\end{center}
\begin{center}
\includegraphics[width=0.5in]{image33.png}
\end{center}

\subsectiontitle{Transmission Shaft Design}

\[ \tau_{\max} = \frac{c}{J} \sqrt{M^2 + T^2} \]

\sectiontitle{Buckling of Columns}
\noindent
$P_{cr} = \frac{\pi^2 EI}{L_e^2}, \sigma_{cr} = \frac{\pi^2 E}{(L_e/r)^2}$ \hfill
\raisebox{-0.5\height}{\scriptsize
\begin{tabular}{@{}ll@{}}
\hline
...
{\fontsize{4}{\baselineskip}\selectfont
\[ \sigma_{\max} = \frac{P}{A} \left( 1 + \frac{ec}{r^2} \sec{\left( \frac{\pi}{2} \sqrt{\frac{P}{P_{cr}}} \right)} \right)
...
\textbf{Wood (ASD):}
$\sigma_{all}=\sigma_C C_p$,\quad
$C_p=\dfrac{1+(\sigma_{CE}/\sigma_C)}{2c}-\sqrt{\left[\dfrac{1+(\sigma_{CE}/\sigma_C)}{2c}\right]^2-\dfrac{\sigma_{CE}/\sigma_C}{c}}$,\quad
$\sigma_{CE}=\dfrac{0.822E}{(L/d)^2}$\\
$c=0.8$ (sawn),\ $c=0.9$ (glulam);\quad $L/d\leq50$
...
Interaction Method
\[ \frac{P/A}{(\sigma_{\text{all}})_{\text{centric}}} + \frac{Mc / I}{(\sigma_{\text{all}})_{\text{bending}}} \le 1 \]
