...
\begin{tikzpicture}[remember picture, overlay]
\node[opacity=1.0, anchor=north east] (image) at (\linewidth,-0.4cm) {\includegraphics[width=1in]{image39.png}};
\node[opacity=1.0, anchor=north east] (image) at (\linewidth,-2.4cm) {\includegraphics[width=1in]{image40.png}};
\node[opacity=1.0, anchor=north east] (image) at (\linewidth,-4.4cm) {\includegraphics[width=1in]{image41.png}};
